# Generated by Django 4.2 on 2023-05-01 06:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admit_date', models.DateTimeField(auto_now_add=True, verbose_name='date of admission')),
            ],
        ),
        migrations.CreateModel(
            name='Records',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mri', models.FileField(upload_to='')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient.person')),
            ],
        ),
    ]
